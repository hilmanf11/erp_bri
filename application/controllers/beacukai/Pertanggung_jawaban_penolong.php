...
class Pertanggung_jawaban_penolong extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('beacukai/pertanggung_jawaban_penolong');
        } else {
    ...
    public function print($option = "")
    {
        ...
        WHERE a.id like '%$filter_items%' and b.number in ('003','002')
        GROUP BY a.id
        ORDER BY a.number");
