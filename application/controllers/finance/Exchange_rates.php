...
class Exchange_rates extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('finance/exchange_rates');
        } else {
    ...
    public function reads()
    {
        ...
        $send = $this->crud->reads('exchange_rates', ["name" => $post]);
    ...
    public function delete()
    {
        ...
        $send = $this->crud->delete('exchange_rates', $data);
        echo $send;
    }
    ...
    {
        @unlink('excel/failed/exchange_rates.txt');
    }
    ...
    public function uploadcreateFailed()
    {
        if ($this->input->post()) {
            ...
            $textFailed = fopen('excel/failed/exchange_rates.txt', 'a');
    ...
    {
        $file = "excel/failed/exchange_rates.txt";
    ...
    public function uploadcreate()
    {
        if ($this->input->post()) {
            ...
            //Cek Process Number
            $exchange_rates = $this->crud->read('exchange_rates', [], ["bank_account" => $data['bank_account']]);

            if (!empty($exchange_rates->id)) {
                ...
                $send   = $this->crud->create('exchange_rates', $dataFinal);
                echo $send;
            }
        }
    }
    ...
    public function print($option = "")
    {
        if ($option == "excel") {
            ...
            header("Content-Disposition: attachment; filename=exchange_rates_$format.xls");
        }
        //Config
        $this->db->select('*');
        $this->db->from('config');
