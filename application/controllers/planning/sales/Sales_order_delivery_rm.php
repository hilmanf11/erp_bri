...
class Sales_order_delivery_rm extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('sales/sales_order_delivery_rm');
        } else {
    ...
    {
        $send = $this->crud->query("SELECT DISTINCT sales_order_no FROM sales_order_rm WHERE customer_id = '$customer_id'");
