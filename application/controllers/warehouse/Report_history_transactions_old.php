...
class Report_history_transactions extends CI_Controller
{
    ...
    public function print($option = "")
    {
        ...
        foreach ($records as $record) {
            ...
            WHERE a.item_id = '$item_id' and a.receipt_date between '$filter_from' and '$filter_to'
            GROUP BY a.bc_kind, a.bc_aju, a.bc_document, a.bc_date");

            //ISSUED
            $issueds = $this->crud->query("SELECT * FROM issued_material_details WHERE item_id = '$item_id' and DATE_FORMAT(created_date, '%Y-%m-%d') between '$filter_from' and '$filter_to'");
            ...
            WHERE a.item_id = '$item_id' and a.return_date between '$filter_from' and '$filter_to'
            GROUP BY b.label_no");
