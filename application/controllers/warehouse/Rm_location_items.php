...
class Rm_location_items extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('warehouse/rm_location_items');
        } else {
    ...
    public function uploadcreate()
    {
        if ($this->input->post()) {
            ...
            $warehouse_location_items = $this->crud->read('warehouse_location_items', [], ["item_id" => $data['item_number'], "type" => "RM"]);
