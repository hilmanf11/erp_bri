...
class Mold_details extends CI_Controller
{
    ...
    public function datatableDetails()
    {
        if ($this->input->get()) {
            ...
            $this->db->select('a.*, c.number as item_number, c.name as item_name, d.mold_name as mold_name, d.type as mold_type, d.model as mold_model, d.cavity_standard as standard_cavity, d.project_year as project_year');
            $this->db->from('mold_details a');
            $this->db->join('customers b', 'a.customer_id = b.id');
    ...
    public function print($option = "")
    {
        ...
        $this->db->select('a.*, b.name as customer_name, b.currency, b.id as customer_id, c.number as item_number, c.name as item_name , d.mold_name, d.type as mold_type, d.model as mold_model, d.standard as standard_cavity, d.project_year as project_year');
        $this->db->from('mold_details a');
        $this->db->join('customers b', 'a.customer_id = b.id');
        $this->db->join('item_fg c', 'a.item_id = c.id');
        $this->db->join('setting_molds e', 'a.item_id = e.item_fg_id');
