    ...
    public function index()
    {
     ...
     public function create()
     {
         if ($this->input->post()) {
                ...
                }else if (!empty($setting_non_molds->item_rm_id)) {
                    echo json_encode(array("title" => "Duplicated", "message" => "Part Id " . $post['item_rm_id'] . " Duplicate Data", "theme" => "error"));
                } else {
     ...
     public function uploadcreate()
     {
         if ($this->input->post()) {
            ...
            $setting_non_molds_fg = $this->crud->read('setting_non_molds', [], ["item_fg_id" => $data['item_fg_id'],"machine_id" => $data['machine_id']]);
            $setting_non_molds_rm = $this->crud->read('setting_non_molds', [], ["item_rm_id" => $data['item_rm_id'],"machine_id" => $data['machine_id']]);
