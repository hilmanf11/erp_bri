...
class Bom_rubber_part extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('master/bom_rubber_part');
        } else {
    ...
    {
        @unlink('failed/bom_rubber_part.txt');
    }
    ...
    public function uploadcreateFailed()
    {
        if ($this->input->post()) {
            ...
            $textFailed = fopen('failed/bom_rubber_part.txt', 'a');
    ...
    {
        $file = "failed/bom_rubber_part.txt";
    ...
    public function uploadCreate()
    {
        if ($this->input->post()) {
            ...
            } elseif ($item_fg->item_family_number != "RP") {
                echo json_encode(array(
                    "title"   => "Invalid Product",
                    "message" => "Product ID " . $data['item_fg_id'] . " is not registered as Rubber Part Item",
                    "theme"   => "error"
                ));
    ...
    public function print($option = "")
    {
        ...
        <center>
            ...
            <div style="float: centet; font-size: 16px; text-align: center;">
                <h3>MASTER BILL OF MATERIAL RUBBER PART</h3>
            </div>
        </center>
    ...
    public function export_excel()
    {
        ...
        $sheet->setCellValue('A4', 'MASTER BILL OF MATERIAL RUBBER PART');
        ...
        $filename = 'bom_rubber_part_' . date('Ymd') . '.xlsx';
    ...
    public function exportTemplate() {
        ...
        $templateSheet->setCellValue('A1', 'TEMPLATE UPLOAD BOM RUBBER PART');
        ...
        header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        header('Content-Disposition: attachment; filename="tmp_bom_rubber_part.xls"');
        header('Cache-Control: max-age=0');
