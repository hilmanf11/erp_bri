...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'dnr_no',width:150,halign:'center'">DNR No</th>
            <th data-options="field:'delivery_note_no',width:150,halign:'center'">Delivery Note No</th>
            <th data-options="field:'delivery_date',width:100,halign:'center'">Delivery Date</th>
            <th data-options="field:'destination_name',width:150,halign:'center'">Destination</th>
            ...
            <th data-options="field:'workorder',width:130,halign:'center'">Workorder</th>
            <th data-options="field:'qty_delivery',width:80,halign:'center'">Qty</th>
...
<script>
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('approvals/approvalDeliveryRework/') ?>' + "<?= base64_encode($approved_to) ?>" + "/" + "<?= base64_encode($approved_by) ?>",
            pagination: false,
            singleSelect: false,
            clientPaging: false,
            rownumbers: true,
