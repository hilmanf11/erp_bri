...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'delivery_note_date',width:100,halign:'center'">Delivery Date</th>
...
<script>
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('approvals/approvalDeliveryNotes/') ?>' + "<?= base64_encode($approved_to) ?>" + "/" + "<?= base64_encode($approved_by) ?>",
            pagination: false,
            singleSelect: false,
            clientPaging: false,
            rownumbers: true,
