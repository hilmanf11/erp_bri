...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'group_name',width:150,align:'center'">Group Name</th>
    ...
    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div class="fitem">
                ...
                <input style="width:60%;" name="account_group_id" id="account_group_id" required="" class="easyui-combobox">
            </div>
            <div class="fitem">
...
<script>
    ...
    $(function() {
        ...
        $("#account_group_id").combobox({
            url: '<?= base_url('finance/account_groups/reads') ?>',
            valueField: 'id',
            textField: 'name',
            ...
            //     $.ajax({
            //         type: "post",
            //         url: "<?= base_url('finance/account_group_details/autoNumber') ?>",
