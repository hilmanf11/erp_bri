<div id="dlg_help" class="easyui-dialog" title="About Menu" data-options="closed: true,modal:true" style="width: 800px; height: 500px; left: 10px; top: 20px;">
    <div class="easyui-accordion" style="width:100%; height: 100%;">
        <div title="RELATIONS" style="padding: 20px;">
            <ul>
                <li>The Data Customer Name is taken from <b>Master Data > Marketing > Customers</b></li>
...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'customer_number',width:80,halign:'center'">Code</th>
            ...
            <th rowspan="2" data-options="field:'credit_limit',width:150,halign:'center',align:'right',formatter: priceformat,
                editor: {
...
<iframe id="printout" src="<?= base_url('finance/balance_customers/print') ?>" style="width: 100%;" hidden></iframe>
...
<script>
                ...
                if (r) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        $.ajax({
                            ...
                            url: '<?= base_url('finance/balance_customers/delete') ?>',
    ...
    function download_excel() {
        ...
        window.location.assign('<?= base_url('template/tmp_account_balance_customers.xls') ?>');
    ...
    function excel() {
        ...
        window.location.assign('<?= base_url('finance/balance_customers/print/excel') ?>');
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            url: '<?= base_url('finance/balance_customers/datatables') ?>',
                    ...
                    if (endEditing()){
                        ...
                        if(rows){
                            ...
                            $.ajax({
                                ...
                                url: "<?= base_url('finance/balance_customers/create') ?>",
        ...
        $('#dlg_upload').dialog({
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    window.open('<?= base_url('finance/balance_customers/uploadDownloadFailed') ?>', '_blank');
                ...
                handler: function() {
                    ...
                    $('#frm_upload').form('submit', {
                        ...
                        url: '<?= base_url('finance/balance_customers/upload') ?>',
                        ...
                        success: function(result) {
                            ...
                            $.ajax({
                                ...
                                url: "<?= base_url('finance/balance_customers/uploadclearFailed') ?>"
                            ...
                            function requestData(total, json, number = 1, value = 0, success = 1, failed = 1) {
                                ...
                                if (value < 100) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "<?= base_url('finance/balance_customers/uploadCreate') ?>",
                                        ...
                                        success: function(result) {
                                            ...
                                            if (result.theme == "success") {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: "<?= base_url('finance/balance_customers/uploadcreateFailed') ?>",
