    ...
    <div style="width: 100%; display: grid; grid-template-columns: auto auto auto; grid-gap: 5px; display: flex;">
        <fieldset style="width: 40%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; margin-left: 10px; border-radius:4px;">
            ...
            <div class="fitem">
                ...
                <select style="width:60%;" id="filter_category" class="easyui-combobox" panelHeight="auto">
...
<script>
    function filter() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $("#printout").attr('src', '<?= base_url('assets/reports/print') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('assets/reports/print') ?>' + url);
        }
    }
