        ...
        <div style="width: 100%; display: grid; grid-template-columns: auto auto auto; grid-gap: 5px; display: flex;">
            <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px;">
                ...
                <div class="fitem">
                        ...
                        <select style="width:30%;" id="taxes" name="taxes" required class="easyui-combobox" panelHeight="auto">
        ...
        <table id="dg2" class="easyui-datagrid" style="width:100%;" title="list Sales Invoicing" data-options="singleSelect: false" idField="customer_po">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'dn_number',width:150">Delivery Note</th>
                    <th data-options="field:'so_number',width:160">SO. No</th>
                    <th data-options="field:'customer_po',width:120">Customer PO</th>
            ...
            <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px;">
                <div style="width: 100%; float: left;">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <th><input style="width:100%;" id="account_sales_name" name="account_sales_name" disabled class="easyui-textbox"></th>
                            <th><input style="width:100%;" id="account_sales_debt" name="account_sales_debt" disabled class="easyui-numberbox" data-options="precision:2,groupSeparator:','"></th>
                            <th><input style="width:100%;" id="account_sales_credit" name="account_sales_credit" disabled class="easyui-numberbox" data-options="precision:2,groupSeparator:','"></th>
                        </tr>
                        <tr>
...
<script>
    ...
    function number(trans_date) {
        $.ajax({
            type: "post",
            url: "<?= base_url('finance/sales_invoices/number/') ?>" + window.btoa(trans_date),
            dataType: "html",
    ...
    function print_invoice() {
        ...
        if (invoice_no == "") {
            ...
            window.open("<?= base_url('finance/sales_invoices/print_dn/') ?>" + window.btoa(invoice_no), "_blank");
        }
    }
