...
<div id="dlg_insert" class="easyui-dialog" title="Add New" data-options="closed: true,modal:true" style="width: 500px; padding:10px; top: 20px;">
    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <input type="hidden" name="mold_actual" id="mold_actual">
...
<script>
    ...
    function add() {
        ...
        url_save = '<?= base_url('master/setting_molds/create') ?>';
            ...
            $.messager.confirm('Warning', 'Are you sure you want to delete this data?', function(r) {
                if (r) {
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        $.ajax({
                            method: 'post',
                            url: '<?= base_url('master/setting_molds/delete') ?>',
                            data: {
                                id: row.id
                            },
    ...
    function download_excel() {
        window.location.assign('<?= base_url('template/tmp_setting_molds.xls') ?>');
    }
    //PRINT PDF
    function pdf() {
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('master/setting_molds/datatables') ?>',
            pagination: true,
            clientPaging: false,
            remoteFilter: true,
            fit: true,
        ...
        //         text: 'List Failed',
        //         handler: function() {
        //             window.open('<?= base_url('master/setting_molds/uploadDownloadFailed') ?>', '_blank');
        //         }
        //     }, {
        //         text: 'Upload',
        //         iconCls: 'icon-ok',
        ...
        //                 url: '<?= base_url('master/setting_molds/upload') ?>',
        //                 onSubmit: function() {
        ...
        //                     //Clear File
        //                     $.ajax({
        //                         url: "<?= base_url('master/setting_molds/uploadclearFailed') ?>"
        //                     });
        ...
        //                                 type: "POST",
        //                                 async: true,
        //                                 url: "<?= base_url('master/setting_molds/uploadCreate') ?>",
        //                                 data: {
        //                                     "data": json[number - 1]
        //                                 },
        //                                 cache: false,
        ...
        //                                             type: "POST",
        //                                             async: true,
        //                                             url: "<?= base_url('master/setting_molds/uploadcreateFailed') ?>",
        //                                             data: {
        //                                                 data: json[number - 1],
