...
<iframe id="printout" src="<?= base_url('master/item_sizes/print') ?>" style="width: 100%;" hidden></iframe>
...
<script>
    ...
    function add() {
        ...
        url_save = '<?= base_url('master/item_sizes/create') ?>';
    ...
    function update() {
        ...
        if (row) {
            ...
            url_save = '<?= base_url('master/item_sizes/update') ?>?id=' + btoa(row.id);
                ...
                if (r) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        $.ajax({
                            ...
                            url: '<?= base_url('master/item_sizes/delete') ?>',
    ...
    function excel() {
        ...
        window.location.assign('<?= base_url('master/item_sizes/print/excel') ?>');
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            url: '<?= base_url('master/item_sizes/datatables') ?>',
