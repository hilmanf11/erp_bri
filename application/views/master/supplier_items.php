...
<table id="dg" class="easyui-treegrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'supplier_name',width:300,halign:'center'">Supplier</th>
            ...
            <th rowspan="2" data-options="field:'mpq',width:80,halign:'center',align:'right',formatter:numberformatComa">MPQ</th>
            <th rowspan="2" data-options="field:'moq',width:80,halign:'center',align:'right',formatter:numberformatComa">MOQ</th>
            <th rowspan="2" data-options="field:'price',width:80,halign:'center',align:'right',formatter:numberformat">Price</th>
            <th rowspan="2" data-options="field:'currency',width:80,align:'center'">Currency</th>
            <th rowspan="2" data-options="field:'purchase',width:80,align:'center'">Purchase <br>(Days)<br></th>
            <th rowspan="2" data-options="field:'safety_stock',width:80,halign:'center',align:'right',formatter:numberformatComa">Safety <br>Stock<br>(%)</th>
            <th rowspan="2" data-options="field:'calculate',width:100,formatter:calculateMpq">Calculate<br>MPQ</th>
    ...
    <div style="width: 100%;">
        <fieldset style="width: 50%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
            ...
            <div class="fitem">
                ...
                <input style="width:60%;" name="filter_suppliers" id="filter_suppliers" class="easyui-combogrid">
            </div>
            <div class="fitem">
    ...
    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div class="fitem">
                ...
                <input style="width:60%;" name="mpq" class="easyui-numberbox" data-options="precision:2">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">MOQ</span>
                <input style="width:60%;" name="moq" class="easyui-numberbox" data-options="precision:2">
            </div>
            <div class="fitem">
            ...
            <div class="fitem">
                ...
                <input style="width:60%;" name="currency" id="currency" disabled class="easyui-textbox">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Purchase (Days)</span>
                <input style="width:60%;" name="purchase" required="" class="easyui-numberbox">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Safety Stock (%)</span>
                <input style="width:60%;" name="safety_stock" required="" class="easyui-numberbox" data-options="precision:2">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Calculate MPQ</span>
                <select style="width:60%;" name="calculate" class="easyui-combobox" panelHeight="auto">
...
<div id="dlg_help" class="easyui-dialog" title="Help about this Module" data-options="closed: true,modal:true" style="width: 600px; padding:10px; top: 20px;">
    <table style="width: 100%;">
        ...
        <tr>
            <td width="100" style="padding: 5px; text-align: center; font-weight: bold;"> Supplier</td>
            <td style="padding: 5px;">The data GET in the <b>master data/suppliers</b> module</td>
        </tr>
        <tr>
            <td style="padding: 5px; text-align: center; font-weight: bold;"> Product No</td>
            <td style="padding: 5px;">The data GET in the <b>engineering/items/item cards</b> module, where <b>master data/product family</b> code not 001</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="padding: 5px;">If the supplier and product no are the same</td>
        </tr>
    </table>
</div>
<!-- PDF -->
...
<script>
    ...
    function update() {
        ...
        if (row) {
            if (row.state == "closed") {
                toastr.error("Please Select Detail of Supplier <br>" + row.supplier_name);
            } else {
                $('#dlg_insert').dialog('open');
    ...
    //FILTER DATA
    function filter() {
        var filter_suppliers = $("#filter_suppliers").combogrid('getValue');
        var filter_items = $("#filter_items").combogrid('getValue');
        var url = "?filter_suppliers=" + window.btoa(filter_suppliers) +
    ...
    function numberformatComa(value, row) {
        if (value != null) {
            const formatter = new Intl.NumberFormat('id-ID', {
