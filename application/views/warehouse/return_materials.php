<table id="dg" class="easyui-treegrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'state',width:80,halign:'center',align:'center',formatter:BtnPrintLabel">Label</th>
            ...
            columns: [
                [{
                    ...
                    editor: {
                        type: 'combogrid',
                        options: {
                            url: '<?= base_url('master/supplier_items/readItems?item_family_number=002') ?>',
                            required: true,
                            panelWidth: 800,
                            idField: 'number',
                            textField: 'number',
